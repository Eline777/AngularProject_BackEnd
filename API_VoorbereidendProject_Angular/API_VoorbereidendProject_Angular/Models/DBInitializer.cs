    ...
    public class DBInitializer
    {
        public static void Initialize(PollContext context)
        {
            ...
            context.Gebruikers.AddRange(
                new Gebruiker { Gebruikersnaam = "Eline777", Email = "r0751363@student.thomasmore.be", Wachtwoord = "1234" },
                new Gebruiker { Gebruikersnaam = "Test", Email = "eline.leysen@hotmail.be", Wachtwoord = "1234" }
                );
